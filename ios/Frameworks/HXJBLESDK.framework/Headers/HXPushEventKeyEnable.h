...
/**
en:
 Key enable and disable event reporting (KSHEventType_KeyEnableAndDisable)
 */
/**
cn:
 钥匙的使能与禁止事件上报(KSHEventType_KeyEnableAndDisable)
 */
@interface HXPushEventKeyEnable : HXPushEventBase
