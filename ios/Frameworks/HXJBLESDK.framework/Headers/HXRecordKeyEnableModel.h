...
en:
 ...
 For example, it can be parsed as: "All keys of user xxx are disabled" etc.
 */
/**
cn:
 钥匙激活与禁用记录记录
 例如可解析为：“xxx用户的所有钥匙被禁用“等
 */
@interface HXRecordKeyEnableModel : HXRecordBaseModel
...
en:
 ...
 Modified user Id, disable or activate all keys under this user
 */
/**
cn:
 operMode == 3该参数有效
...
en:
 enable or disable
 1) When operModel == 1 or operMode == 3, 1: enalbe, 2: disabled;
